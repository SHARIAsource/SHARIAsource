Rails.application.configure do
  ...
  # config.serve_static_assets = false # Rails 5.1 syntax?
  ...
  # config.log_tags = [ :request_id ] # Rails 5.2 app:update
  # config.log_tags = [ :subdomain, :uuid ] Rails 5.1
  ...
  # config.active_job.queue_name_prefix = "shariasource_#{Rails.env}"
