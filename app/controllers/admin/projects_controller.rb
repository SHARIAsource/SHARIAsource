class Admin::ProjectsController < AdminController
  ...
  def permitted_params
    params.require(:project).permit(:name, :slug, :description, :photo, :scale_photo, :published, :projects_users_attributes => [:id, :sort_order, :user_id, :project_id, :project_role, :external_collaborator], user_ids: [])
  end
