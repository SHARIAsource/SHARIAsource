class Admin::NamedFiltersController < AdminController
  ...
  def permitted_params
    params.require(:named_filter).permit(:name, :language_id, :user_id, :topic_id, :theme_id, :region_id, :era_id, :document_type_id, :project_id, :q, :date_from, :date_to, :date_format, :quick_create_url)
  end
